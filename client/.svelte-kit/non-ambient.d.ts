...
declare module "$app/types" {
	export interface AppTypes {
		RouteId(): "/" | "/analysis" | "/exams" | "/jobs" | "/login" | "/proctoring" | "/proctoring/report" | "/proctoring/report/[sessionId]" | "/register" | "/submissions";
		RouteParams(): {
		...
		Pathname(): "/" | "/analysis" | "/exams" | "/jobs" | "/login" | "/proctoring" | `/proctoring/report/${string}` & {} | "/register" | "/submissions";
