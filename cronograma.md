...
- [ ] Mostrar los marcadores visuales de MediaPipe sobre la imagen de la cámara en tiempo real.
...
- [ ] Agregar Dockerfile para el frontend dentro del Docker Compose.
- [ ] Configurar un servidor web (Nginx) que sirva el frontend y redirija las peticiones a las APIs.
- [ ] Escribir instrucciones de despliegue en un servidor real (VPS o nube).
...
- [ ] Probar el sistema con distintas cámaras web de diferentes calidades.
...
- [ ] Revisar y corregir posibles fugas de memoria en los modelos de MediaPipe durante sesiones largas.
...
- [ ] Agregar el cronograma completo al README principal.
